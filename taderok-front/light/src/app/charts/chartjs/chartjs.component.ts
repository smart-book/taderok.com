...
export class ChartjsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    try {
      ...
      //radar chart
      var ctx = <HTMLCanvasElement>document.getElementById("radar-chart");
      if (ctx) {
        ctx.height = 200;
        var myChart = new Chart(ctx, {
          type: 'radar',
    ...
    try {
      ...
      //pie chart
      var ctx = <HTMLCanvasElement>document.getElementById("pie-chart");
      if (ctx) {
        ctx.height = 200;
        var myChart = new Chart(ctx, {
          type: 'pie',
    ...
    try {
      // polar chart
      var ctx = <HTMLCanvasElement>document.getElementById("polar-chart");
      if (ctx) {
        ctx.height = 200;
        var myChart = new Chart(ctx, {
          type: 'polarArea',
